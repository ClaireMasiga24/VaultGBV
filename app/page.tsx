    ...
    <main className="min-h-screen bg-[#F6F4F8] px-5 py-10 flex flex-col justify-between">
      <section className="flex flex-col items-center text-center mt-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-md">
          <Link href="/find-help">
            <div className="h-32 bg-[#4B2E83] text-white rounded-xl flex flex-col items-center justify-center shadow-md cursor-pointer active:scale-95 transition">
              <span className="text-lg font-semibold">Find Help</span>
          ...
          <div className="h-32 border border-[#4B2E83] text-[#4B2E83] rounded-xl flex flex-col items-center justify-center shadow-sm">
            <span className="text-lg font-semibold">Know Your Rights</span>
